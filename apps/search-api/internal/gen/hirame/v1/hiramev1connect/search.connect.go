...
const (
	...
	SearchServiceName = "hirame.v1.SearchService"
)
...
const (
	...
	SearchServiceSearchProcedure = "/hirame.v1.SearchService/Search"
)

// SearchServiceClient is a client for the hirame.v1.SearchService service.
type SearchServiceClient interface {
	Search(context.Context, *connect.Request[v1.SearchRequest]) (*connect.Response[v1.SearchResponse], error)
}

// NewSearchServiceClient constructs a client for the hirame.v1.SearchService service. By default,
...
func NewSearchServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SearchServiceClient {
	...
	searchServiceMethods := v1.File_hirame_v1_search_proto.Services().ByName("SearchService").Methods()
...
// Search calls hirame.v1.SearchService.Search.
...
// SearchServiceHandler is an implementation of the hirame.v1.SearchService service.
...
func NewSearchServiceHandler(svc SearchServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/hirame.v1.SearchService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSearchServiceHandler) Search(context.Context, *connect.Request[v1.SearchRequest]) (*connect.Response[v1.SearchResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hirame.v1.SearchService.Search is not implemented"))
}
